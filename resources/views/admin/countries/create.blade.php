                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="key" class="form-control" placeholder="{{__('admin.enter_country_code')}}" required data-validation-required-message="{{__('admin.this_field_is_required')}}" data-validation-number-message="{{__('admin.just_allows_the_numbers')}}" >
                                            </div>
                                        </div>
                                    </div>
