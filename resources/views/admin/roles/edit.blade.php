                                                    ...
                                                    <div class="role-title text-white" style="display: flex; justify-content: space-between;">
                                                        <div style="display: flex; flex-direction: row; align-items: center" >
                                                            <div class="icheck-primary d-inline" >
                                                                    <input type="checkbox" name="permissions[]" value="{{$value->getName()}}" id="gtx_{{$routeKey}}" class="roles-parent" {{in_array($value->getName(), $my_routes)  ? 'checked' : ''}}>
                                                                    <label for="gtx_{{$routeKey}}" dir="ltr"></label>
                                                            </div>
                                                            <p class=" selectP" for="gtx_{{$routeKey}}">{{__('admin.'.$value->getAction()["title"])}}</p>
                                                        </div>
                                                            ...
                                                            @if (isset($value->getAction()['child']) && count($value->getAction()['child']))
                                                                @foreach ($value->getAction()['child'] as $key => $child) 
                                                                    <div class="form-group clearfix">
                                                                        <div class="icheck-primary d-inline">
                                                                            <input type="checkbox"  name="permissions[]" data-parent="gtx_{{$routeKey}}" value="admin.{{$child}}"  id="{{$value->getName()}}{{$key}}" class="childs gtx_{{$routeKey}}" {{in_array('admin.' . $child, $my_routes)  ? 'checked' : ''}} >
