                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="body_ar" class="form-control" cols="30" rows="10" required data-validation-required-message="{{__('admin.this_field_is_required')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="body_en" class="form-control" cols="30" rows="10" required data-validation-required-message="{{__('admin.this_field_is_required')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
