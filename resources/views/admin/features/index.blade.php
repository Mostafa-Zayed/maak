...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.features.create') }}" 
    deletebutton="{{ route('admin.features.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
        ...
        'status' => [
            ...
            'input_name' => __('admin.activation') ,
        ] ,
    ]" 
>
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/features')])
@endsection
